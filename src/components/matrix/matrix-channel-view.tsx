...
export function MatrixChannelView({ roomId }: { roomId: string }) {
    ...
    return (
      <div className="flex items-center justify-center h-full p-8">
        <div className="text-center max-w-md">
          ...
          <p className="text-sm font-semibold text-[#000000] mb-1">Matrix non configuré</p>
  ...
  return (
    <div className="flex flex-col h-full bg-[#F0E9DE]">
      {/* Messages */}
      <div className="flex-1 overflow-y-auto p-4">
        <div className="space-y-2 max-w-3xl mx-auto">
          {messages.length === 0 ? (
            <div className="text-center text-sm text-[#8A857C] py-8">
            ...
            messages.map((msg) => (
              <div key={msg.id} className={cn("flex", msg.isMine ? "justify-end" : "justify-start")}>
                <div className={cn(
                  ...
                  msg.isMine ? "bg-[#C9A227] text-[#000000]" : "bg-white border border-stone-200"
                )}>
      ...
      <div className="p-3 border-t border-stone-100 bg-white flex items-center gap-2">
        ...
        />
        <button onClick={handleSend} className="p-2.5 rounded-xl bg-[#C9A227] text-[#000000]">
