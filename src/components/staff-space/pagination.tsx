    ...
    <div className="flex items-center justify-between gap-3 px-1 pt-3">
      ...
      <div className="flex items-center gap-1">
        <button
          ...
          disabled={page <= 1}
          className="w-9 h-9 flex items-center justify-center rounded-lg border border-[#C9A227]/20 text-[#FAF6EF] disabled:opacity-30 disabled:cursor-not-allowed hover:bg-[#C9A227]/10 transition-colors"
          aria-label="Page précédente"
        >
          <ChevronLeft className="w-4 h-4" />
        </button>
        <span className="px-3 text-xs font-semibold text-[#FAF6EF] tabular-nums">
          {page} / {nbPages}
        </span>
        <button
