  ...
  return (
    <>
      <button
        ...
        className="inline-flex items-center gap-2 px-4 min-h-[44px] rounded-xl text-sm font-bold transition-colors shadow-md btn-shimmer"
        style={{ backgroundColor: accentColor, color: "#1A0826" }}
      >
