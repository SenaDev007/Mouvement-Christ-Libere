      ...
      <div className="space-y-5">
        ...
        <div className="rounded-xl border-2 border-[#C9A227]/15 bg-[#C9A227]/20 p-4">
          ...
          <div className="flex items-center gap-4">
            <div className="relative flex-shrink-0">
              <div className="w-36 h-[90px] rounded-lg border-2 border-[#C9A227]/30 overflow-hidden bg-[#3D1A54] flex items-center justify-center shadow-md">
                {photoJalon ? (
        ...
        {heroPage && (
          <div className="rounded-xl border-2 border-[#C9A227]/30 bg-[#C9A227]/5 p-4">
            ...
            <p className="text-[11px] text-[#BDB4C9] mb-3 leading-relaxed">
            ...
            <div className="flex items-center gap-4">
              <div className="relative flex-shrink-0">
                <div className="w-[90px] h-[120px] rounded-lg border-2 border-[#C9A227]/40 overflow-hidden bg-[#3D1A54] flex items-center justify-center shadow-md">
                  {bioPhotoAffichee ? (
                    // eslint-disable-next-line @next/next/no-img-element
                    <img
              ...
              <div className="min-w-0 flex-1">
                {heroRows === null && (
                  <p className="text-[11px] text-[#BDB4C9] italic flex items-center gap-1.5">
                ...
                {bioPhotoDirty && bioPhotoValue && (
                  <p className="mt-2 text-[11px] font-semibold text-[#DDBE55] flex items-center gap-1.5">
                ...
                {bioPhotoDirty && bioPhotoValue && (
                  <button
                    ...
                    className="mt-1.5 inline-flex items-center gap-1 text-[11px] font-semibold text-red-400 hover:bg-red-400/10 px-2 py-1 rounded-lg transition-colors"
                  >
        ...
        {heroRows !== null && !heroPage && form.servantId && (
          <p className="text-[11px] text-[#BDB4C9] italic px-1">
...
export function BiographyAutoModal({ servants, biography, accentColor = "#C9A227" }: BiographyAutoModalProps) {
  ...
  return (
    <div className="min-h-[60vh] flex flex-col items-center justify-center gap-3 px-4 text-center">
      ...
      <p className="text-sm text-[#BDB4C9] font-medium">
        {biography ? `Jalon « ${biography.title} »` : "Nouveau jalon biographique"}
      </p>
      <p className="text-xs text-[#FAF6EF]/50 max-w-sm">
