...
function LevelBadge({ level }: { level: string }) {
  ...
  if (level === "AVANCE") {
    return (
      <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[9px] font-bold bg-[#8A857C]/10 text-[#8A857C] border border-[#8A857C]/20">
        <span className="w-1.5 h-1.5 rounded-full bg-[#8A857C]" />
        Avancé
      </span>
    );
  }
