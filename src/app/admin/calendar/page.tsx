  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between flex-wrap gap-4">
        <div>
          <h1 className="font-serif text-2xl sm:text-3xl font-semibold text-[#FAF6EF] mb-1">
        ...
        <Link
          ...
          className="inline-flex items-center justify-center gap-1.5 px-4 min-h-[44px] rounded bg-[#C9A227] text-[#FAF6EF] text-sm font-semibold hover:bg-[#DDBE55] transition-colors"
        >
      ...
      <div className="card-gold-top overflow-hidden">
        <div className="overflow-x-auto">
          ...
          <tbody>
            {events.map((e) => (
              <tr key={e.id} className="border-b border-[#C9A227]/15 hover:bg-[#C9A227]/5">
                <td className="px-4 py-3">
                  <div className="flex items-center gap-2">
                    <CalendarIcon className="w-3.5 h-3.5 text-[#BDB4C9] flex-shrink-0" />
                    <div className="flex items-center gap-2">
                      <div className="w-2 h-6 rounded-full" style={{ backgroundColor: e.color }} />
                      <div>
                        <p className="text-sm font-medium text-[#FAF6EF]">{e.nameFr}</p>
                        <p className="text-xs text-[#BDB4C9]">{e.name}{e.nameHe && ` · ${e.nameHe}`}</p>
                      </div>
                    </div>
                  </div>
                </td>
                <td className="px-4 py-3 text-xs text-[#BDB4C9] whitespace-nowrap">{TYPE_LABELS[e.type]}</td>
                <td className="px-4 py-3 text-xs text-[#BDB4C9] whitespace-nowrap">
                ...
                <td className="px-4 py-3">
                  <div className="flex items-center justify-end gap-1">
                    <Link
                      ...
                      className="inline-flex items-center justify-center min-w-[44px] min-h-[44px] rounded hover:bg-[#C9A227]/10 text-[#BDB4C9] hover:text-[#C9A227] transition-colors"
                      aria-label="Modifier"
                    >
