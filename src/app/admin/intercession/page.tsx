                  ...
                  <div className="min-w-0 flex-1">
                    <div className="flex items-start justify-between gap-3 mb-1 flex-wrap">
                      <div className="min-w-0">
                        <h3 className="font-bold text-sm text-[#1E0F2B] flex items-center gap-2 flex-wrap">
                          {d.sujet}
                          {d.isUrgent && (
                            <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded text-[10px] font-bold bg-state-danger text-white">
