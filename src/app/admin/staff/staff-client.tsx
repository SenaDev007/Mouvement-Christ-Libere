  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <form
        ...
        className="bg-white rounded-2xl border border-[#8A8378]/15 p-6 space-y-6"
      >
        <div>
          <h2 className="font-semibold text-[#1E0F2B] mb-1">
            Créer un compte
          </h2>
              ...
              <button
                ...
                className={`text-left p-4 rounded-xl border-2 transition-all ${
                  actif
                    ...
                    : "border-[#8A8378]/15 hover:border-[#C9A227]/40 bg-white"
                }`}
              >
                <div className="flex items-center gap-2 mb-2">
                  <div
                    className={`p-1.5 rounded-lg ${
                      actif ? "bg-[#C9A227]/15" : "bg-[#FAF6EF]"
                    }`}
                  >
                ...
                <p className="text-xs text-[#8A8378] leading-relaxed mb-2">
                  {r.desc}
                </p>
                <p className="text-[10px] font-mono text-[#8C5FA8] break-all">
                  {r.espace}
                </p>
              </button>
            );
      ...
      <div className="space-y-4">
        <div>
          <h2 className="font-semibold text-[#1E0F2B] mb-1 flex items-center gap-2">
        ...
        {chargement ? (
          <div className="flex items-center justify-center py-10 text-[#8A8378]">
                  ...
                  <div className="flex flex-wrap items-start justify-between gap-3">
                    <div className="min-w-0">
                      <div className="flex items-center gap-2 flex-wrap">
                        <span className="font-semibold text-[#1E0F2B] text-sm">
                          {compte.name}
                        </span>
                        <span
                      ...
                      <div className="flex items-center gap-1.5 mt-1 text-xs text-[#8A8378]">
                        <Mail className="w-3 h-3" />
                        {compte.email}
                      </div>
                      <div className="flex items-center gap-1.5 mt-0.5 text-[11px] text-[#8A8378]/70">
                      ...
                      {compte.bio && (
                        <p className="text-[11px] text-[#8A8378] mt-1 italic">
                          {compte.bio}
                        </p>
                      )}
                      {carteRole && (
                        <p className="text-[10px] font-mono text-[#8C5FA8]/70 mt-1.5">
                          {carteRole.espace}
                        </p>
                      )}
                    </div>
                      ...
                      {reninitId === compte.id ? (
                        <div className="flex items-center gap-2 flex-wrap">
                          <input
                            ...
                            className="px-3 py-1.5 rounded-lg border border-[#8A8378]/25 bg-[#FAF6EF] text-xs w-44"
                            minLength={8}
                          />
                          <button
                            onClick={() =>
                          ...
                          <button
                            ...
                            className="px-3 py-1.5 rounded-lg text-xs text-[#8A8378] hover:text-[#1E0F2B]"
                          >
                            Annuler
                          </button>
                        </div>
      ...
      <div className="px-4 py-3 rounded-xl bg-[#FAF6EF] border border-[#8A8378]/15 text-[11px] text-[#8A8378] leading-relaxed">
        <p className="flex items-center gap-1.5 mb-1 font-semibold text-[#1E0F2B]">
