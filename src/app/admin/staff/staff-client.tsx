 ...
 *
 * Design : même langage que le back-office (violet #2A0E3D, or #C9A227,
 * crème #FAF6EF, cartes blanches, lucide-react).
 */
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <form
        ...
        className="bg-[#1A0826]/70 rounded-2xl shadow-xl border border-[#C9A227]/15 p-6 space-y-6"
      >
        <div>
          <h2 className="font-semibold text-[#FAF6EF] mb-1">
            Créer un compte / accréditer un membre
          </h2>
          <p className="text-xs text-[#BDB4C9] mb-4">
              ...
              <button
                ...
                className={`text-left p-4 rounded-xl border-2 transition-all ${
                  actif
                    ...
                    : "border-[#C9A227]/15 hover:border-[#C9A227]/40 bg-[#1A0826]/70"
                }`}
              >
                <div className="flex items-center gap-2 mb-2">
                  <div
                    className={`p-1.5 rounded-lg ${
                      actif ? "bg-[#C9A227]/15" : "bg-[#C9A227]/10"
                    }`}
                  >
                    <Icone className="w-4 h-4 text-[#DDBE55]" />
                  </div>
                  <span className="text-sm font-semibold text-[#FAF6EF]">
                    {r.label}
                  </span>
                </div>
                <p className="text-xs text-[#BDB4C9] leading-relaxed mb-2">
                  {r.desc}
                </p>
                <p className="text-[10px] font-mono text-[#C9AEE3] break-all">
                  {r.espace}
                </p>
              </button>
            );
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div>
            <label className="block text-xs font-semibold text-[#FAF6EF] mb-1.5">
              Nom complet <span className="text-[#E08B6D]">*</span>
            </label>
            <input
              type="text"
              value={form.name}
          ...
          <div>
            <label className="block text-xs font-semibold text-[#FAF6EF] mb-1.5">
              Email <span className="text-[#E08B6D]">*</span>
            </label>
            <input
              type="email"
              value={form.email}
          ...
          <div>
            <label className="block text-xs font-semibold text-[#FAF6EF] mb-1.5">
              Mot de passe <span className="text-[#E08B6D]">*</span>
            </label>
            <input
              type="text"
              value={form.password}
        ...
        <button
          ...
          className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-[#3D1A54] text-[#FAF6EF] text-sm font-semibold hover:bg-[#3D1A54] transition-colors disabled:opacity-50"
        >
          {creationEnCours ? (
      ...
      <div className="space-y-4">
        <div>
          <h2 className="font-semibold text-[#FAF6EF] mb-1 flex items-center gap-2">
        ...
        {chargement ? (
          <div className="flex items-center justify-center py-10 text-[#BDB4C9]">
                  ...
                  <div className="flex flex-wrap items-start justify-between gap-3">
                    <div className="min-w-0">
                      <div className="flex items-center gap-2 flex-wrap">
                        <span className="font-semibold text-[#FAF6EF] text-sm">
                          {compte.name}
                        </span>
                        <span
                          className={`inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-semibold border ${
                            estSecretaire
                              ? "bg-[#C9A227]/10 text-[#DDBE55] border-[#C9A227]/30"
                      ...
                      <div className="flex items-center gap-1.5 mt-1 text-xs text-[#BDB4C9]">
                        <Mail className="w-3 h-3" />
                        {compte.email}
                      </div>
                      <div className="flex items-center gap-1.5 mt-0.5 text-[11px] text-[#FAF6EF]/50">
                      ...
                      {compte.bio && (
                        <p className="text-[11px] text-[#BDB4C9] mt-1 italic">
                          {compte.bio}
                        </p>
                      )}
                      {carteRole && (
                        <p className="text-[10px] font-mono text-[#C9AEE3]/70 mt-1.5">
                          {carteRole.espace}
                        </p>
                      )}
                    </div>
                    ...
                    <div className="flex flex-wrap items-center gap-2">
                      {reninitId === compte.id ? (
                        <div className="flex items-center gap-2 flex-wrap">
                          <input
                            ...
                            className="px-3 py-1.5 rounded-lg border border-[#C9A227]/25 bg-[#C9A227]/10 text-xs w-44"
                            minLength={8}
                          />
                          <button
                            onClick={() =>
                          ...
                          <button
                            ...
                            className="px-3 py-1.5 rounded-lg text-xs text-[#BDB4C9] hover:text-[#FAF6EF]"
                          >
                            Annuler
                          </button>
                        </div>
                      ...
                      <button
                        ...
                        className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-[#B3452E]/30 text-[#E08B6D] text-xs font-semibold hover:bg-[#B3452E]/10 transition-colors disabled:opacity-50"
                      >
      ...
      <div className="px-4 py-3 rounded-xl bg-[#C9A227]/10 border border-[#C9A227]/15 text-[11px] text-[#BDB4C9] leading-relaxed">
        <p className="flex items-center gap-1.5 mb-1 font-semibold text-[#FAF6EF]">
        ...
        <Link
          href="/admin/users"
          className="text-[#C9A227] underline underline-offset-2 hover:text-[#DDBE55]"
        >
          Utilisateurs
        </Link>
