...
import { Lock, LogIn, AlertCircle, Loader2, ShieldCheck } from "lucide-react";
...
export default function AdminLoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[#2A0E3D] flex items-center justify-center px-4 relative overflow-hidden">
      {/* Décor de fond */}
        ...
        <div className="bg-[#FAF6EF] rounded-3xl shadow-2xl overflow-hidden border border-[#C9A227]/20">
          ...
          <div className="bg-[#2A0E3D] px-8 py-10 text-center relative overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col items-center">
              ...
              <h1 className="font-serif text-2xl font-bold text-[#FAF6EF] mb-1">
                Back Office
              </h1>
