...
export default async function ChannelPage({ params }: PageProps) {
  ...
  return (
    <div>
      ...
      <section className="bg-[#F0E9DE] py-12 md:py-16">
        <div className="container mx-auto max-w-7xl px-4">
            ...
            <div className="mb-6 p-4 rounded-2xl bg-[#C9A227]/5 border border-[#C9A227]/20 flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-[#8A857C] leading-relaxed">
                  ...
                  <code className="px-1 py-0.5 rounded bg-[#8A857C]/10 text-[#A3821C] font-mono text-[10px]">
          ...
          {channel.isEncrypted && (
            <div className="mb-6 p-4 rounded-2xl bg-[#000000]/5 border border-[#C9A227]/20 flex items-start gap-3">
