    ...
    <div>
      ...
      <section className="bg-ivory py-12 md:py-16">
        <div className="container mx-auto max-w-7xl px-4">
          ...
          {!matrixConfigured && (
            <div className="mb-6 p-4 rounded-card bg-gold/5 border border-gold/20 flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-stone leading-relaxed">
                  ...
                  <code className="px-1 py-0.5 rounded bg-stone/10 text-gold-dark font-mono text-[10px]">
          ...
          {channel.isEncrypted && (
            <div className="mb-6 p-4 rounded-card bg-imperial/5 border border-gold/20 flex items-start gap-3">
