      ...
      <div className="max-w-[1800px] mx-auto px-2 md:px-4 py-4">
        <div className="grid lg:grid-cols-[1fr_380px] gap-4">
          ...
          <div className="space-y-3">
            <div className="relative aspect-video bg-[#000000] rounded-xl overflow-hidden shadow-2xl animate-pulse">
            ...
            <div className="h-6 w-3/4 bg-[#000000]/10 rounded animate-pulse" />
            {/* Placeholder de la barre chaîne + actions */}
            <div className="flex items-center gap-3 pb-3 border-b border-[#8A857C]/15">
              <div className="w-10 h-10 rounded-full bg-[#000000]/10 animate-pulse" />
              <div className="flex-1 space-y-2">
                <div className="h-3 w-32 bg-[#000000]/10 rounded animate-pulse" />
                <div className="h-3 w-20 bg-[#000000]/10 rounded animate-pulse" />
              </div>
            </div>
            {/* Placeholder de la description */}
            <div className="bg-white rounded-xl p-3 border border-[#8A857C]/15 space-y-2">
              <div className="h-3 w-full bg-[#000000]/10 rounded animate-pulse" />
              <div className="h-3 w-2/3 bg-[#000000]/10 rounded animate-pulse" />
            </div>
          </div>

          {/* Colonne droite : placeholder du chat */}
          <div className="h-[calc(100vh-180px)] lg:h-auto lg:max-h-[calc(100vh-140px)]">
            <div className="h-full bg-white rounded-xl border border-[#8A857C]/15 p-4 space-y-3">
              <div className="h-4 w-20 bg-[#000000]/10 rounded animate-pulse" />
              <div className="h-3 w-full bg-[#000000]/10 rounded animate-pulse" />
              <div className="h-3 w-5/6 bg-[#000000]/10 rounded animate-pulse" />
              <div className="h-3 w-3/4 bg-[#000000]/10 rounded animate-pulse" />
            </div>
          </div>
        </div>
      </div>
