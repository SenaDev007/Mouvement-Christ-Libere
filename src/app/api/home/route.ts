...
export async function GET() {
  const mockData = {
    servants: [
      { code: "afrika", fullName: "Afrika Alkebulane Pamela Dali", shortName: "Afrika", role: "Servante de l'Éternel", bio: "Témoignages d'enlèvements au ciel, instructions reçues du Seigneur Yeshoua, conformité à la Parole. Figure contemporaine du patriarche Hénoch." },
