    ...
    <div>
      ...
      <section className="bg-[#F0E9DE] py-16 md:py-20">
        <div className="container mx-auto max-w-5xl px-4">
          <div className="grid md:grid-cols-3 gap-6">
            <div className="card-gold-top p-6">
              <div className="flex items-center justify-center w-12 h-12 rounded-full bg-[#000000]/10 mb-4">
                <Hash className="w-6 h-6 text-[#000000]" />
              </div>
              <h3 className="font-serif text-lg font-semibold text-[#000000] mb-2">
                1. Hachage SHA-256
              </h3>
          ...
          <div className="mt-8 p-6 bg-[#000000] text-[#F0E9DE] rounded-2xl border border-[#C9A227]/30 relative overflow-hidden">
            ...
            <div className="relative flex items-start gap-4">
              ...
              <div>
                <h3 className="font-serif text-xl font-semibold text-[#F0E9DE] mb-2">
      ...
      <section id="ancrer" className="bg-[#F0E9DE] py-16 md:py-20">
        <div className="container mx-auto max-w-2xl px-4">
          <div className="text-center mb-8">
            <h2 className="font-serif text-3xl font-semibold text-[#000000] mb-3">
              Ancrer un contenu
            </h2>
          ...
          {result ? (
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h3 className="font-serif text-xl font-semibold text-[#000000]">
                    Contenu ancré
                  </h3>
              ...
              <div className="p-4 bg-[#000000]/5 border border-[#C9A227]/20 rounded-full mb-6">
                <p className="text-[10px] uppercase tracking-[0.18em] text-[#8A857C] font-semibold mb-2">
                  Preuve d&apos;intégrité (hash)
                </p>
                <code className="text-xs font-mono text-[#000000] break-all">
                  {result.ancre.hash}
                </code>
              </div>
              ...
              <div className="flex items-center gap-3">
                <button
                  ...
                  className="px-5 py-2.5 rounded-full border border-[#000000]/30 text-[#000000] hover:bg-[#000000]/5 transition-colors text-sm font-semibold"
                >
                ...
                {result.ancre.arweaveUrl && (
                  <a
                    ...
                    className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-[#C9A227] text-[#000000] text-sm font-semibold hover:bg-[#FF7A1A] transition-colors"
                  >
            ...
            <form onSubmit={handleSubmit} className="card-gold-top p-8 space-y-5">
                    ...
                    return (
                      ...
                      >
                        <Icon className={cn(
                          ...
                          form.type === t.value ? "text-[#C9A227]" : "text-[#8A857C]"
                        )} />
                        <span className={cn(
                          "text-[10px] font-semibold",
                          form.type === t.value ? "text-[#000000]" : "text-[#8A857C]"
                        )}>
                          {t.label}
                        </span>
                      </button>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-full border border-[#8A857C]/30 bg-[#F0E9DE] text-[#000000] placeholder:text-[#8A857C]/60 focus:outline-none focus:border-[#C9A227] focus:ring-2 focus:ring-[#C9A227]/20"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 rounded-full border border-[#8A857C]/30 bg-[#F0E9DE] text-[#000000] placeholder:text-[#8A857C]/60 focus:outline-none focus:border-[#C9A227] focus:ring-2 focus:ring-[#C9A227]/20 resize-y font-serif"
                />
              ...
              <button
                type="submit"
                disabled={submitting}
                className="w-full px-6 py-4 rounded-full bg-[#C9A227] text-[#000000] font-semibold text-sm hover:bg-[#FF7A1A] transition-colors inline-flex items-center justify-center gap-2 disabled:opacity-50"
              >
                {submitting ? (
                  <>
...
function DetailRow({
  ...
  return (
    <div className="flex items-start gap-3 py-2 border-b border-[#8A857C]/10">
      <Icon className="w-4 h-4 text-[#8A857C] flex-shrink-0 mt-0.5" />
      <div className="flex-1 min-w-0">
        <p className="text-[10px] uppercase tracking-[0.18em] text-[#8A857C] font-semibold mb-0.5">
          {label}
        </p>
        {link ? (
          <a
            ...
            rel="noopener noreferrer"
            className={cn(
              "text-sm text-[#000000] hover:text-[#FF7A1A] transition-colors break-all inline-flex items-center gap-1",
              mono && "font-mono"
            )}
          >
            {value}
          ...
          <p className={cn("text-sm text-[#000000] break-all", mono && "font-mono")}>
            {value}
          </p>
        )}
      </div>
